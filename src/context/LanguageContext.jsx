...
const translations = {
  en: {
    ...
    // Work Cards
    cardWorkLabel: 'Career',
    cardWorkTitle: 'Work Experience',
    cardWorkDesc: 'Professional experience in software development and IT industry.',
    cardWorkFullDesc: 'My professional career spans various positions in software development. From concept to implementation of complex projects, I bring solid experience.',
    cardInternLabel: 'Internships',
    cardInternTitle: 'Internships & Practice',
    cardInternDesc: 'Practical experiences and insights into various companies.',
    cardInternFullDesc: 'Through various internships and practical phases, I have gained valuable insights into different work environments and technologies.',
    cardCreativeLabel: 'Creatives',
    cardCreativeTitle: 'Creative Work',
    cardCreativeDesc: 'Design, animations and visual projects that inspire.',
    cardCreativeFullDesc: 'Creativity meets technology. My creative projects include UI/UX design, motion graphics and experimental web projects that push boundaries.',
    cardProjectsLabel: 'Projects',
    cardProjectsTitle: 'Personal Projects',
    cardProjectsDesc: 'Personal projects and open-source contributions.',
    cardProjectsFullDesc: 'Besides my professional work, I develop my own projects and contribute to open source. These projects allow me to explore new technologies and implement creative ideas.',
  },
  de: {
    // Sidebar
    work: 'Arbeit',
    ...
    // Work Cards
    cardWorkLabel: 'Beruf',
    cardWorkTitle: 'Berufserfahrung',
    cardWorkDesc: 'Professionelle Erfahrung in der Softwareentwicklung und IT-Branche.',
    cardWorkFullDesc: 'Meine berufliche Laufbahn umfasst verschiedene Positionen in der Softwareentwicklung. Von der Konzeption bis zur Umsetzung komplexer Projekte bringe ich fundierte Erfahrung mit.',
    cardInternLabel: 'Praktika',
    cardInternTitle: 'Praktika & Praxis',
    cardInternDesc: 'Praktische Erfahrungen und Einblicke in verschiedene Unternehmen.',
    cardInternFullDesc: 'Durch verschiedene Praktika und Praxisphasen habe ich wertvolle Einblicke in unterschiedliche Arbeitsumgebungen und Technologien gewonnen.',
    cardCreativeLabel: 'Creatives',
    cardCreativeTitle: 'Kreative Arbeiten',
    cardCreativeDesc: 'Design, Animationen und visuelle Projekte die begeistern.',
    cardCreativeFullDesc: 'Kreativität trifft auf Technologie. Meine kreativen Projekte umfassen UI/UX Design, Motion Graphics und experimentelle Webprojekte die Grenzen verschieben.',
    cardProjectsLabel: 'Projekte',
    cardProjectsTitle: 'Eigene Projekte',
    cardProjectsDesc: 'Persönliche Projekte und Open-Source Beiträge.',
    cardProjectsFullDesc: 'Neben meiner beruflichen Arbeit entwickle ich eigene Projekte und trage zu Open-Source bei. Diese Projekte ermöglichen es mir, neue Technologien zu erkunden und kreative Ideen umzusetzen.',
  },
  tr: {
    // Sidebar
    work: 'Çalışmalar',
    ...
    // Work Cards
    cardWorkLabel: 'Kariyer',
    cardWorkTitle: 'İş Deneyimi',
    cardWorkDesc: 'Yazılım geliştirme ve BT sektöründe profesyonel deneyim.',
    cardWorkFullDesc: 'Profesyonel kariyerim yazılım geliştirmede çeşitli pozisyonları kapsıyor. Konseptten karmaşık projelerin uygulanmasına kadar sağlam deneyim getiriyorum.',
    cardInternLabel: 'Staj',
    cardInternTitle: 'Stajlar ve Pratik',
    cardInternDesc: 'Çeşitli şirketlerde pratik deneyimler ve içgörüler.',
    cardInternFullDesc: 'Çeşitli stajlar ve pratik aşamalar sayesinde farklı çalışma ortamları ve teknolojiler hakkında değerli içgörüler kazandım.',
    cardCreativeLabel: 'Yaratıcı',
    cardCreativeTitle: 'Yaratıcı Çalışmalar',
    cardCreativeDesc: 'İlham veren tasarım, animasyon ve görsel projeler.',
    cardCreativeFullDesc: 'Yaratıcılık teknolojiyle buluşuyor. Yaratıcı projelerim UI/UX tasarım, motion graphics ve sınırları zorlayan deneysel web projelerini içeriyor.',
    cardProjectsLabel: 'Projeler',
    cardProjectsTitle: 'Kişisel Projeler',
    cardProjectsDesc: 'Kişisel projeler ve açık kaynak katkıları.',
    cardProjectsFullDesc: 'Profesyonel çalışmamın yanı sıra kendi projelerimi geliştiriyor ve açık kaynağa katkıda bulunuyorum. Bu projeler yeni teknolojileri keşfetmeme ve yaratıcı fikirleri hayata geçirmeme olanak tanıyor.',
  },
};
